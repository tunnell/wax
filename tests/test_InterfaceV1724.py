...
class BaseInterfaceV1724():
    ...
    def _testBadData(self):
        ...
        bad = b"\xd6\x00\x00\xa0\xfc\x00\x00\x01\x01\x03\x00\x00\xa6\xab7\x00#\x00\x00\x00\x80\x00\x00\x00 \x00\x00\x80}>~>\x7f>~>\x7f>|>\x7f>~>\x7f>\x80>}>~>\x7f>~>\x7f>\x7f>\x7f>}>}>~>\x7f>\x7f>\x80>}>{>|>\x80>~>\x7f>~>\x81>~>}>|>\x7f>\x7f>}>~>{>\x7f>}>|>~>~>}>~>~>}>\x7f>\x85>\x90-*%\x8c#F#6#.#*#\xf8$\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x005\x87\x04\x00\x00\x00\x00\x00\x87>\x87>\x88>\x86>\x86>\x86>\x87>\x86>\x86>\x86>\x86>\x86>\x87>\x86>\x87>\x86>\x88>\x85>\x87>\x86>\x86>\x86>\x87>\x85>\x86>\x87>\x86>\x87>\x86>\x86>\x87>\x85>\x87>\x87>\x87>\x85>\x85>\x85>\x87>\x88>\x87>\x91>\xcc-\r&\x9a$`$O$E$>$\xc3)\xe09\xd2=q>\x84>\x88>\x87>$\x01\x00\xa0\xff\x00\x00\x01\x01\x02\x00\x00\xc8#%\x00$\x00\x00\x00\x7f\x00\x00\x00!\x00\x00\x80\x82>\x83>\x82>\x82>\x81>\x82>\x7f>\x81>\x82>\x80>\x80>\x80>\x80>~>\x82>\x82>\x81>\x81>\x82>\x81>\x81>\x81>\x81>\x80>\x82>\x82>\x81>\x82>\x82>\x81>\x80>\x83>\x81>\x81>\x82>\x81>\x82>\x82>\x81>\x81>\x82>\x82>\x7f>\x80>\x81>\x82>\x82>\x81>\x82>\x81>\x83>a4\xc6'\x0f%\xa0$\x89$\x80$w$\xcc,\xcc:\xf8=r>\x80>\x82>\x83>\x82>$\x00\x00\x00\x7f\x00\x00\x00!\x00\x00\x80\x80>\x82>\x80>\x82>\x81>\x81>\x82>\x81>\x80>\x81>\x81>\x82>\x82>\x81>\x81>\x81>\x81>\x81>\x81>\x81>\x80>\x7f>\x80>\x7f>\x81>\x83>\x7f>\x7f>\x80>\x81>\x83>\x80>\x82>\x80>\x81>\x81>\x80>\x84>\x82>\x83>\x83>\x81>\x80>\x83>\x82>\x81>\x81>\x82>\x81>\x81>\x82>\xf33\xc3'/%\xc5$\xb0$\xa6$\x9b$]-\xea:\xf9=q>}>\x7f>\x82>\x80>$\x00\x00\x00\x7f\x00\x00\x00!\x00\x00\x80\x81>\x80>\x7f>\x7f>\x81>\x80>\x81>~>\x7f>\x80>\x7f>~>\x7f>\x80>\x80>\x80>\x7f>~>~>\x80>\x7f>\x80>\x81>\x80>\x81>\x81>\x80>~>~>\x7f>\x80>\x7f>\x80>\x80>\x80>~>~>\x7f>\x80>\x7f>\x80>\x7f>~>\x80>~>\x80>\x7f>\x80>\x80>\x80>\x7f>/4\xba'\x06%\x96$\x7f$x$q$\xeb,\xc1:\xf7=p>\x7f>\x81>\x80>\x80>$\x00\x00\x00\x7f\x00\x00\x00!\x00\x00\x80\x82>\x82>\x82>\x83>\x83>\x81>\x81>\x81>\x82>\x80>\x81>\x82>\x82>\x82>\x80>\x7f>\x81>\x7f>\x81>\x81>\x81>\x82>\x81>}>\x81>\x80>\x81>\x83>\x81>\x82>\x81>\x82>\x80>\x83>\x80>\x80>\x80>\x82>\x81>\x82>\x80>\x81>\x82>\x80>\x80>\x82>\x80>\x82>\x82>\x80>\x81>s4\xd1'\x17%\xa6$\x90$\x87$|$\xbe,\xc3:"
    ...
    def test_get_word_by_index_values(self):
        data = self._testGoodData()
        self.assertEqual(
            self.interfaceClass.get_word_by_index(data, 0), 2684355084)
        self.assertEqual(
            self.interfaceClass.get_word_by_index(data, 1), 16777471)
