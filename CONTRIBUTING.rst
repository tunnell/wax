...
Report bugs at https://github.com/tunnell/cito/issues.
...
The best way to send feedback is to file an issue at https://github.com/tunnell/cito/issues.
...
Ready to contribute? Here's how to set up `cito` for local development.

1. Fork the `cito` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/cito.git
...
3. The pull request should work for Python 3.3. Check 
   https://travis-ci.org/tunnell/cito/pull_requests
...
To run a subset of tests::
	...
	$ python -m unittest tests.test_cito
